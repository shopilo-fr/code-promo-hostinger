#!/usr/bin/env python3
"""
Recuperation des codes promo Hostinger depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/hostinger.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/hostinger.fr"
STORE_NAME = "Hostinger"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Hostinger depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-hostinger)"
    }
    try:
